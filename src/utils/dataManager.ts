...
import { Associativity, brackets, BracketType, MathJaxOperatorMetadata, mathJaxOperatorsMetadata, operatorsWithImplicitMultiplication, tikzComponents, units,OperatorType, operatorNames } from "./staticData";

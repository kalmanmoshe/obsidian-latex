...
import { DEFAULT_SETTINGS, MoshePluginSettings } from "./settings";
...
export class MoshePluginSettingTab extends PluginSettingTab {
    ...
    private addMultiChoiceSetting(containerEl: HTMLElement, name: string, description: string, choices: any,settingKey: keyof MoshePluginSettings) {
    ...
    private addColorSetting(containerEl: HTMLElement, name: string, description: string, settingKey: keyof MoshePluginSettings) {
      if (settingKey === "sessionHistory") {
    ...
    private addFontSetting(containerEl: HTMLElement, name: string, description: string, settingKey: keyof MoshePluginSettings) {

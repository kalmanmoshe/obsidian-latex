...
export class genericNode{
    ...
    children: svgNode[]
    constructor(name: string, type: string, value: string, attributes: Record<string, string>, children: genericNode[]){
        this.name=name;
        this.type=type;
        this.value=value;
...
export class SVGroot{
    ...
    constructor(name: string, type: string, value: string, attributes: Record<string, string>, children: svgNode[]){
        this.name=name;
        this.type=type;
        this.value=value;
        this.attributes=attributes;

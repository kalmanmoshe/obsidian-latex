import LatexLogParser, { CurrentError, Options, ProcessedLog } from './latex-log-parser'


export default function parseLatexLog(rawLog: string, options: Options={ignoreDuplicates:true}): ProcessedLog {
...
export function createLatexErrorMessage(errorInfo: {line?: number,cause?: string}={}): ErrorMessage {

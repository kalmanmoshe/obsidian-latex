...
export class MathjaxVFS {
	 ...
	 */
	private graph: DependencyGraphStore<MathJaxAbstractSyntaxTree, MathJaxDependency> =
	...
	async getFileWithInlinedDependencies(
		path: string,
	): Promise<MathJaxAbstractSyntaxTree | undefined> {
		this.checkEnabled();

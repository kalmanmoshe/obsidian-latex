...
export function taskSectionInfoToCodeBlock(fileText: string | string[], taskSection: TaskSectionInformation): string {
...
export function taskSectionInfoToContent(fileText: string | string[], taskSection: TaskSectionInformation): string {

...
function compilePDFRoutine() {
	...
	if (status === 0) {
		...
		console.error('dvi Compilation failed, with status code ' + status);
		self.postMessage({
			result: 'failed',
			status: status,
			log: self.memlog,
...
function kpse_find_file_impl(nameptr, format, _mustexist) {
	...
	console.log('Dvi start downloading texlive file ' + remote_url);
	try {
		xhr.send();
	} catch (err) {
...
var wasmImports = {
	...
	c: _fd_write,
	e: invoke_iii,
	n: invoke_iiiiiiiiiij,
	k: invoke_vii,
	y: _kpse_find_file_js,
};
...
var _compilePDF = (Module['_compilePDF'] = () =>
	(_compilePDF = Module['_compilePDF'] = wasmExports['D'])());
var _setMainEntry = (Module['_setMainEntry'] = (a0) =>
	(_setMainEntry = Module['_setMainEntry'] = wasmExports['E'])(a0));
...
var dynCall_iiiiiiiiiij = (Module['dynCall_iiiiiiiiiij'] = (
	a0,
	a1,
	a2,
	a3,
	...
	(dynCall_iiiiiiiiiij = Module['dynCall_iiiiiiiiiij'] = wasmExports['K'])(
		a0,
		a1,
		a2,
		a3,

...
export class Tikzjax {
    ...
    optimizeSVG(svg) {
        var _a;
        return (_a = optimize(svg, { plugins: [
                {
                    name: "preset-default",
                    params: {
                        overrides: {
...
export class Formatting {
    ...
    addSplopAndPosition(arr, index) {
        ...
        const edge1 = ((_a = before.quadrant) === null || _a === void 0 ? void 0 : _a.toString()) || "";
        const edge2 = ((_b = after.quadrant) === null || _b === void 0 ? void 0 : _b.toString()) || "";
        ...
        this.position = (_c = this.position) === null || _c === void 0 ? void 0 : _c.replace(/[\d]+/g, "").replace(/(below|above)(right|left)/, "$1 $2");
    }
...
export class Coordinate {
    ...
    interpretCoordinate(coordinates) {
        ...
        const variable = coordinates.find(coor => (coor === null || coor === void 0 ? void 0 : coor.type) === 'variable').value;
        this.formatting = formatting;
        this.axis = axis;
        this.variable = variable;
        return this;
    ...
    toString() {
        ...
        switch (this.mode) {
            case "coordinate":
                if (this.axis)
                    return `\\coordinate ${((_a = this.formatting) === null || _a === void 0 ? void 0 : _a.toString()) || ''} (${this.variable || ""}) at (${this.axis.toString()});`;
            case "node":
                if (this.axis) { }
            //return `\\node ${this.coordinateName?'('+this.coordinateName+')':''} at (${this.axis.toString()}) ${this.formatting?.toString()||''} {${this.label}};`
            case "node-inline":
                return `node ${((_b = this.formatting) === null || _b === void 0 ? void 0 : _b.toString()) || ''} {${this.label || ''}}`;
            default:
...
export class Draw {
    ...
    getSchematic(draw) {
        ...
        while (i < draw.length && loops < 100) { // Increase loop limit or add condition based on parsed length
            ...
            if ((coordinateMatch === null || coordinateMatch === void 0 ? void 0 : coordinateMatch.index) === 0) {
                coordinatesArray.push({ type: "coordinate", value: coordinateMatch[1] });
                i += coordinateMatch[0].length;
            }
            const formattingMatch = draw.slice(i).match(formattingRegex);
            if ((formattingMatch === null || formattingMatch === void 0 ? void 0 : formattingMatch.index) === 0) {
                i += formattingMatch[0].length;
                coordinatesArray.push({ type: "formatting", value: formattingMatch[0] });
            }
            const nodeMatch = draw.slice(i).match(nodeRegex);
            if ((nodeMatch === null || nodeMatch === void 0 ? void 0 : nodeMatch.index) === 0) {
    ...
    toStringDraw() {
        var _a;
        let result = `\\draw ${(_a = this.formatting) === null || _a === void 0 ? void 0 : _a.toString()} `;
...
function dissectXYaxis(match) {
    ...
    return {
        type: "xyaxis",
        Xformatting: (_a = match[1]) === null || _a === void 0 ? void 0 : _a.replace(/(->|<-|['`"].*?['`"])/g, ""),
        Yformatting: (_b = match[2]) === null || _b === void 0 ? void 0 : _b.replace(/(->|<-|['`"].*?['`"])/g, ""),

 ...
 * Fallback type.
 */
type Fallback<TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>>> = InferOutput<TSchema> | ((dataset?: OutputDataset<InferOutput<TSchema>, InferIssue<TSchema>>, config?: Config<InferIssue<TSchema>>) => InferOutput<TSchema>);
/**
 ...
 * Fallback async type.
 */
type FallbackAsync<TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>> = InferOutput<TSchema> | ((dataset?: OutputDataset<InferOutput<TSchema>, InferIssue<TSchema>>, config?: Config<InferIssue<TSchema>>) => MaybePromise<InferOutput<TSchema>>);
/**
...
type SchemaWithFallbackAsync<TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>, TFallback extends FallbackAsync<TSchema>> = Omit<TSchema, 'async' | '~standard' | '~run'> & {
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferInput<TSchema>, InferOutput<TSchema>>;
    /**
...
type SchemaWithOmit<TSchema extends Schema$7, TKeys extends ObjectKeys<TSchema>> = TSchema extends ObjectSchema<infer TEntries, ErrorMessage<ObjectIssue> | undefined> | StrictObjectSchema<infer TEntries, ErrorMessage<StrictObjectIssue> | undefined> ? Omit<TSchema, 'entries' | '~standard' | '~run' | '~types'> & {
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<Omit<TEntries, TKeys[number]>>, InferObjectOutput<Omit<TEntries, TKeys[number]>>>;
    /**
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<Omit<TEntries, TKeys[number]>> & {
        [key: string]: unknown;
...
type SchemaWithPartial<TSchema extends Schema$6, TKeys extends ObjectKeys<TSchema> | undefined> = TSchema extends ObjectSchema<infer TEntries, ErrorMessage<ObjectIssue> | undefined> | StrictObjectSchema<infer TEntries, ErrorMessage<StrictObjectIssue> | undefined> ? Omit<TSchema, 'entries' | '~standard' | '~run' | '~types'> & {
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<PartialEntries$1<TEntries, TKeys>>, InferObjectOutput<PartialEntries$1<TEntries, TKeys>>>;
    /**
     * Parses unknown input.
     *
     * @param dataset The input dataset.
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<PartialEntries$1<TEntries, TKeys>> & {
        [key: string]: unknown;
...
type SchemaWithPartialAsync<TSchema extends Schema$5, TKeys extends ObjectKeys<TSchema> | undefined> = TSchema extends ObjectSchemaAsync<infer TEntries, ErrorMessage<ObjectIssue> | undefined> | StrictObjectSchemaAsync<infer TEntries, ErrorMessage<StrictObjectIssue> | undefined> ? Omit<TSchema, 'entries' | '~standard' | '~run' | '~types'> & {
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<PartialEntries<TEntries, TKeys>>, InferObjectOutput<PartialEntries<TEntries, TKeys>>>;
    /**
     * Parses unknown input.
     *
     * @param dataset The input dataset.
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<PartialEntries<TEntries, TKeys>> & {
        [key: string]: unknown;
...
type SchemaWithPick<TSchema extends Schema$4, TKeys extends ObjectKeys<TSchema>> = TSchema extends ObjectSchema<infer TEntries, ErrorMessage<ObjectIssue> | undefined> | StrictObjectSchema<infer TEntries, ErrorMessage<StrictObjectIssue> | undefined> ? Omit<TSchema, 'entries' | '~standard' | '~run' | '~types'> & {
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<Pick<TEntries, TKeys[number]>>, InferObjectOutput<Pick<TEntries, TKeys[number]>>>;
    /**
     * Parses unknown input.
     *
     * @param dataset The input dataset.
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<Pick<TEntries, TKeys[number]>> & {
        [key: string]: unknown;
...
type SchemaWithRequired<TSchema extends Schema$3, TKeys extends ObjectKeys<TSchema> | undefined, TMessage extends ErrorMessage<NonOptionalIssue> | undefined> = TSchema extends ObjectSchema<infer TEntries, ErrorMessage<ObjectIssue> | undefined> | StrictObjectSchema<infer TEntries, ErrorMessage<StrictObjectIssue> | undefined> ? Omit<TSchema, 'entries' | '~standard' | '~run' | '~types'> & {
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<RequiredEntries$1<TEntries, TKeys, TMessage>>, InferObjectOutput<RequiredEntries$1<TEntries, TKeys, TMessage>>>;
    /**
     * Parses unknown input.
     *
     * @param dataset The input dataset.
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<RequiredEntries$1<TEntries, TKeys, TMessage>> & {
        [key: string]: unknown;
...
type SchemaWithRequiredAsync<TSchema extends Schema$2, TKeys extends ObjectKeys<TSchema> | undefined, TMessage extends ErrorMessage<NonOptionalIssue> | undefined> = TSchema extends ObjectSchemaAsync<infer TEntries, ErrorMessage<ObjectIssue> | undefined> | StrictObjectSchemaAsync<infer TEntries, ErrorMessage<StrictObjectIssue> | undefined> ? Omit<TSchema, 'entries' | '~standard' | '~run' | '~types'> & {
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<RequiredEntries<TEntries, TKeys, TMessage>>, InferObjectOutput<RequiredEntries<TEntries, TKeys, TMessage>>>;
    /**
     * Parses unknown input.
     *
     * @param dataset The input dataset.
     ...
     * @internal
     */
    readonly '~standard': StandardSchemaProps<InferObjectInput<RequiredEntries<TEntries, TKeys, TMessage>> & {
        [key: string]: unknown;
 ...
 * @returns The Standard Schema properties.
 */
declare function _getStandardProps<TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>>(context: TSchema): StandardSchemaProps<InferInput<TSchema>, InferOutput<TSchema>>;

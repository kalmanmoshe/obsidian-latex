...
const unifiedLatexPrettier = require("@unified-latex/unified-latex-prettier");
...
const unifiedLatexStringCompiler = function unifiedLatexStringCompiler2(options) {
      ...
      plugins: [
        {
          ...
          printers: {
            "latex-ast": {
              print: unifiedLatexPrettier.printLatexAst
            }
          }
        }
      ],
  ...
  Object.assign(this, {
    Compiler: (ast) => {
      if (!pretty) {
        return unifiedLatexUtilPrintRaw.printRaw(ast);
      }
...
exports.unifiedLatexStringCompiler = unifiedLatexStringCompiler;

export declare type Ast = Node;
export declare type Node = Color | InvalidSpec | ColorFunction | ColorExpr | ColorExtExpr | ColorMixExpr | WeightedColorExpr | Postfix | ColorSpec | ColorSpecList;
export declare type XColor = Color | ColorSpec | ColorSpecList;
interface AstNode {
    type: string;
}
...
declare type ColorSpec = HexColorSpec | NumColorSpec;
